...
class TranscriptionService:
    ...
    def __init__(self, api_key: str, model: str = "google/gemini-3.1-flash-lite", system_prompt: Optional[str] = None):
    ...
    def transcribe(self, wav_bytes: bytes, mode: str = "normal") -> str:
        ...
        """
        logger.debug(f"TranscriptionService.transcribe entering. Mode: {mode}")
        ...
        logger.info(f"Sending transcription request to {url} (Mode: {mode})")
